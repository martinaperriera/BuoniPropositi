...
public class Main {
	...
	public static void main(String[] args) {
		...
		// dowhile + for che si ripete finché la lista dei buoni propositi non è
		// completata (isEmpty)
		do {
		...
		System.out.println(
				"Complimenti! Hai completato la lista dei buoni propositi. Keep up the good work e al prossimo anno! ;)");
		sc.close();
